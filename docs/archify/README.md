# Unlimited-OCR Archify Architecture
...
- Repository URL: https://github.com/hundong2/Unlimited-OCR.git
- Checkout SHA: a8df377a0250f1cdccdc62dca3f8b5cb0d6ab238
- README file: README_kor.md
- Evidence file: README_kor.md
- README title: Unlimited OCR Works
- Dependency markers:
- Top-level directories: __pycache__, assets, docs, guide, wheel
- Category: OCR, document, and media AI

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for Unlimited-OCR.
